                ...
                <form className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            <label className="font-label text-[10px] uppercase tracking-widest text-secondary font-medium" htmlFor="name">Full Name</label>
                            <input className="w-full bg-surface-container-lowest border-none ring-1 ring-outline-variant/15 focus:ring-2 focus:ring-primary rounded-lg py-4 px-5 text-on-surface placeholder:text-outline-variant transition-all" id="name" placeholder="John Doe" type="text" />
                        </div>
                        <div className="space-y-2">
                            <label className="font-label text-[10px] uppercase tracking-widest text-secondary font-medium" htmlFor="email">Email Address</label>
                            <input className="w-full bg-surface-container-lowest border-none ring-1 ring-outline-variant/15 focus:ring-2 focus:ring-primary rounded-lg py-4 px-5 text-on-surface placeholder:text-outline-variant transition-all" id="email" placeholder="john@example.com" type="email" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        <label className="font-label text-[10px] uppercase tracking-widest text-secondary font-medium" htmlFor="subject">Subject</label>
                        <input className="w-full bg-surface-container-lowest border-none ring-1 ring-outline-variant/15 focus:ring-2 focus:ring-primary rounded-lg py-4 px-5 text-on-surface placeholder:text-outline-variant transition-all" id="subject" placeholder="Project Discussion" type="text" />
                    </div>
                    <div className="space-y-2">
            ...
            <aside className="lg:col-span-5 space-y-16">
                <div>
                    ...
                    <div className="space-y-6">
                        <a className="group flex items-start gap-4" href={`mailto:${content.email}`}>
                            ...
                            <div>
                                <span className="block font-label text-[10px] uppercase tracking-widest text-secondary mb-1">Email</span>
                                <span className="block font-body text-lg font-medium text-on-surface border-b border-transparent group-hover:border-primary transition-all">{content.email}</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <a className="flex items-center gap-4 p-5 rounded-xl bg-surface-container-low hover:bg-surface-container-high transition-colors group" href={content.github_url}>
                            ...
                            <span className="material-symbols-outlined text-primary text-sm opacity-0 group-hover:opacity-100 transition-opacity ml-auto">north_east</span>
                        </a>
                        <a className="flex items-center gap-4 p-5 rounded-xl bg-surface-container-low hover:bg-surface-container-high transition-colors group" href={content.linkedin_url}>
                            <div className="w-10 h-10 flex items-center justify-center bg-white rounded shadow-sm">
...
export default function Contact({ page, sections }: { page: PageData | null; sections: Section[] }) {
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-background">
            <Head title={page?.meta_title ?? 'Contact'}>
